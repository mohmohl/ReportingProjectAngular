...
exportexcel(): void 
  ...
  this.loading = true;
  this.service.exportDetailTrialExcel(f_Date,this.bCode,this.currencyCode,fromat)
  .pipe(
    map((data: any) => {
      debugger;
  ...
  this.loading = true;
  this.service.exportDetailTrialPDF(f_Date,this.bCode,this.currencyCode, fromat)
  .pipe(
    map((data: any) => {
      let blob = new Blob([data], {
