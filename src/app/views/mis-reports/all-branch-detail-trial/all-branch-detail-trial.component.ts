...
@Component({
  selector: 'app-all-branch-detail-trial',
  templateUrl: './all-branch-detail-trial.component.html',
  styleUrls: ['./all-branch-detail-trial.component.css']
})
export class AllBranchDetailTrialComponent implements OnInit {
