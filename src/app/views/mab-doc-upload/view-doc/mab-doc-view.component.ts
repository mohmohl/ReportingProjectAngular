...
@Component({
  selector: 'app-mab-doc-view',
  templateUrl: './mab-doc-view.component.html',
  styleUrls: ['./mab-doc-view.component.css'],
  providers: [
    {provide: DateAdapter, useClass: PickDateAdapter},
    {provide: MAT_DATE_FORMATS, useValue: PICK_FORMATS}
  ]
})
export class MABDocViewComponent implements OnInit {
  loading = false;
  error = '';
  message = '';
  ...
  getBranchByUser() :void{
    ...
    search():void {
        ...
        this.filterData.branchCode = this.branchData.homeBranch;
