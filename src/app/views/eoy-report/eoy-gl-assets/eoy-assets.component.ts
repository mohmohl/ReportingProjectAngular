...
@Component({
  selector: 'app-eoy-conso-assets',
  templateUrl: './eoy-assets.component.html',
  styleUrls: ['./eoy-assets.component.css'],
  providers: [
    {provide: DateAdapter, useClass: PickDateAdapter},
    {provide: MAT_DATE_FORMATS, useValue: PICK_FORMATS}
]
})
export class EOYConsoAssetsComponent implements OnInit {
  ...
  getFileName(){
    return "General Ledger Assets(ByCurrency)_"+this.branchCode+"_"+this._util.getDDMMMYYYY(this.toDate)+"_R"+this.roundSrno;
  }
  ...
  exportExcel(){
    ...
    console.log("General Ledger Asset Report Excel Exporting Error >>> " + error)
    if (error != "") {
      this.error = "(The system cannot export General Ledger Asset Report Excel file!.. Have the error)";
    }
    this.loading = false;
  });
}
