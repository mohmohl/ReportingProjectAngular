...
@Component({
  selector: 'app-eoy-general-trial-report',
  templateUrl: './eoy-general-trial-report.component.html',
  styleUrls: ['./eoy-general-trial-report.component.css'],
  providers: [
...
export class EOYGeneralTrialReportComponent implements OnInit {
  error='';
  from_date:Date;
  loading = false;
  data:TrialReport;
